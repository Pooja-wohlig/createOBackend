...
//                            $string=$string.'$'.$sqlname.',';
            ...
            $viewdata.='<div class="createbuttonplacement"><a class="btn-floating btn-large waves-effect waves-light blue darken-4 tooltipped" href="<?php echo site_url("site/create'.$tablename.'"); ?>"data-position="top" data-delay="50" data-tooltip="Create"><i class="material-icons">add</i></a></div>'."\n";
            $viewdata.='</div>'."\n";
            $viewdata.='</div>'."\n";
            $viewdata.='<script>'."\n";
...
//            $viewdata.=endtext();
            ...
            foreach($allfields as $fieldrow)
                        {
                                    ...
                                    else
                                    {
                                        ...
                                        {
                                        $createdata.='<div class="row">'."\n";
                                        $createdata.='<div class="input-field col s6">'."\n";
                                         $createdata.='<label for="'.$title.'">'.$title.'</label>'."\n";
                                        $createdata.='<input type="text" id="'.$title.'" name="'.$sqlname.'" value=\'<?php echo set_value(\''.$sqlname.'\');?>\'>'."\n";
                                        $createdata.='</div>'."\n";
                                        $createdata.='</div>'."\n";
                                        }
                                        if($fieldtype==2)
                                        {
                                        $createdata.='<div class="row">'."\n";
                                        $createdata.='<div class="input-field col s12">'."\n";
                                        $createdata.='<textarea name="'.$sqlname.'" class="materialize-textarea" length="400"><?php echo set_value( \''.$sqlname.'\');?></textarea>'."\n";
                                        $createdata.='<label>'.$title.'</label>'."\n";   
                                        $createdata.='</div>'."\n";
                                        $createdata.='</div>'."\n";
                                        }
                                        if($fieldtype==3)
                                        ...
                                        $createdata.='<div class=" row">'."\n";
                                        $createdata.='<div class=" input-field col s6">'."\n";
                                        $createdata.='<?php echo form_dropdown("'.$sqlname.'",$'.$sqlname.',set_value(\''.$sqlname.'\'));?>'."\n";
                                        $createdata.='<label>'.$title.'</label>'."\n"; 
                                        $createdata.='</div>'."\n";
                                        $createdata.='</div>'."\n";
                                        }
                                        ...
                                        $createdata.='<div class=" row">'."\n";
                                        $createdata.='<div class=" input-field col s6">'."\n";
                                        $createdata.='<?php echo form_dropdown("'.$sqlname.'",$'.$sqlname.',set_value(\''.$sqlname.'\'),multiple);?>'."\n";
                                        $createdata.='<label>'.$title.'</label>'."\n"; 
                                        $createdata.='</div>'."\n";
                                        $createdata.='</div>'."\n";
                                        }
                                        ...
                                        if($fieldtype==7)
                                        {
                                        $createdata.='<div class="row" style="display:none;">'."\n";
                                        $createdata.='<div class="input-field col s6">'."\n";
                                         $createdata.='<label for="'.$title.'">'.$title.'</label>'."\n";
                                        $createdata.='<input type="text" id="'.$title.'" name="'.$sqlname.'" value=\'<?php echo set_value(\''.$sqlname.'\');?>\'>'."\n";
                                        $createdata.='</div>'."\n";
                                        ...
                                        $createdata.='<div class="input-field col s6">'."\n";
                                        $createdata.='<label for="'.$title.'">'.$title.'</label>'."\n";
                                        $createdata.='<input type="email" id="'.$title.'" name="'.$sqlname.'" value=\'<?php echo set_value(\''.$sqlname.'\');?>\'>'."\n";
                                        $createdata.='</div>'."\n";
                                        $createdata.='</div>'."\n";
                                        }
                                        if($fieldtype==9)
                                        ...
                                        $createdata.='<div class="input-field col s6">'."\n";
                                        $createdata.='<label for="'.$title.'">'.$title.'</label>'."\n";
                                        $createdata.='<input type="number" id="'.$title.'" name="'.$sqlname.'" value=\'<?php echo set_value(\''.$sqlname.'\');?>\'>'."\n";
                                        $createdata.='</div>'."\n";
                                        $createdata.='</div>'."\n";
                                        }
                                        if($fieldtype==11)
                                        ...
                                        $createdata.='<div class="input-field col s6">'."\n";
                                        $createdata.='<label for="'.$title.'">'.$title.'</label>'."\n";
                                        $createdata.='<input type="date" id="'.$title.'" name="'.$sqlname.'" value=\'<?php echo set_value(\''.$sqlname.'\');?>\'>'."\n";
                                        $createdata.='</div>'."\n";
                                        $createdata.='</div>'."\n";
                                        }
                                        ...
                                        {
                                        $createdata.='<div class="row">'."\n";
                                        $createdata.='<div class="file-field input-field col s12 m6">'."\n";
                                        $createdata.='<div class="btn blue darken-4">'."\n";
                                        $createdata.='<span>'.$title.'</span>'."\n";
                                        $createdata.='<input type="file" name="'.$sqlname.'" multiple>'."\n";
                                        $createdata.='</div>'."\n";
                                        $createdata.='<div class="file-path-wrapper">'."\n";
                                        $createdata.='<input class="file-path validate" type="text" placeholder="Upload one or more files" value=\'<?php echo set_value(\''.$sqlname.'\');?>\'>'."\n";
                                        $createdata.='</div>'."\n";
                                        $createdata.='</div>'."\n";
                                        $createdata.='</div>'."\n";
                                        }
                                    ...
                                    $createdata.='<div class="row">'."\n";
                                    $createdata.='<div class="col s12 m6">'."\n";
                                    $createdata.='<button type="submit" class="btn btn-primary waves-effect waves-light blue darken-4">Save</button>'."\n";
                                    $createdata.='<a href="<?php echo site_url("site/view'.$tablename.'"); ?>" class="btn btn-secondary waves-effect waves-light red">Cancel</a>'."\n";
                                    $createdata.='</div>'."\n";
                                    $createdata.='</div>'."\n";
        ...
        else
        {
           ...
           //editdata
            ...
            $editdata.='</div>'."\n";
            $editdata.='<div class="row">'."\n";
            $editdata.="<form class='col s12' method='post' action='<?php echo site_url(\"site/edit".$tablename."submit\");?>' enctype= 'multipart/form-data'>"."\n";
...
//                                        $endtext=$fieldrow->sqlname;
									...
									else
									{
										...
										{
                                        $editdata.='<div class="row">'."\n";
                                        $editdata.='<div class="input-field col s6">'."\n";
                                         $editdata.='<label for="'.$title.'">'.$title.'</label>'."\n";
                                        $editdata.='<input type="text" id="'.$title.'" name="'.$sqlname.'" value=\'<?php echo set_value(\''.$sqlname.'\',$before->'.$sqlname.');?>\'>'."\n";
                                        $editdata.='</div>'."\n";
                                        $editdata.='</div>'."\n";
										}
										if($fieldtype==2)
										{
                                        $editdata.='<div class="row">'."\n";
										$editdata.='<div class="col s12 m6">'."\n";
                                        $editdata.='<label>'.$title.'</label>'."\n";
										$editdata.='<textarea name="'.$sqlname.'" placeholder="Enter text ..."><?php echo set_value( \''.$sqlname.'\',$before->'.$sqlname.');?></textarea>'."\n";
										$editdata.='</div>'."\n";
										$editdata.='</div>'."\n";
										}
										if($fieldtype==3)
										{
                                        $editdata.='<div class=" row">'."\n";
										$editdata.='<div class=" input-field col s12 m6">'."\n";
										$editdata.='<?php echo form_dropdown("'.$sqlname.'",$'.$sqlname.',set_value(\''.$sqlname.'\',$before->'.$sqlname.'));?>'."\n";
                                        $editdata.='<label for="'.$title.'">'.$title.'</label>'."\n";
										$editdata.='</div>'."\n";
										$editdata.='</div>'."\n";
										}
										...
										$editdata.='<div class=" row">'."\n";
										$editdata.='<div class=" input-field col s12 m6">'."\n";
										$editdata.='<?php echo form_dropdown("'.$sqlname.'",$'.$sqlname.',set_value(\''.$sqlname.'\',$before->'.$sqlname.'), multiple);?>'."\n";
                                        $editdata.='<label for="'.$title.'">'.$title.'</label>'."\n";
										$editdata.='</div>'."\n";
										$editdata.='</div>'."\n";
										}
										...
										if($fieldtype==7)
										{
										$editdata.='<div class="row" style="display:none;">'."\n";
										$editdata.='<div class="input-field col s6">'."\n";
                                         $editdata.='<label for="'.$title.'">'.$title.'</label>'."\n";
                                        $editdata.='<input type="text" id="'.$title.'" name="'.$sqlname.'" value=\'<?php echo set_value(\''.$sqlname.'\',$before->'.$sqlname.');?>\'>'."\n";
                                        $editdata.='</div>'."\n";
                                        ...
                                        $editdata.='<div class="input-field col s6">'."\n";
                                         $editdata.='<label for="'.$title.'">'.$title.'</label>'."\n";
                                        $editdata.='<input type="email" id="'.$title.'" name="'.$sqlname.'" value=\'<?php echo set_value(\''.$sqlname.'\',$before->'.$sqlname.');?>\'>'."\n";
                                        $editdata.='</div>'."\n";
                                        $editdata.='</div>'."\n";
										}
										if($fieldtype==9)
                                        ...
                                        $editdata.='<div class="input-field col s6">'."\n";
                                         $editdata.='<label for="'.$title.'">'.$title.'</label>'."\n";
                                        $editdata.='<input type="number" id="'.$title.'" name="'.$sqlname.'" value=\'<?php echo set_value(\''.$sqlname.'\',$before->'.$sqlname.');?>\'>'."\n";
                                        $editdata.='</div>'."\n";
                                        $editdata.='</div>'."\n";
										}
										if($fieldtype==11)
                                        ...
                                        $editdata.='<div class="input-field col s6">'."\n";
                                         $editdata.='<label for="'.$title.'">'.$title.'</label>'."\n";
                                        $editdata.='<input type="date" id="'.$title.'" name="'.$sqlname.'" value=\'<?php echo set_value(\''.$sqlname.'\',$before->'.$sqlname.');?>\'>'."\n";
                                        $editdata.='</div>'."\n";
                                        $editdata.='</div>'."\n";
										}
                                        ...
                                        $editdata.='<div class="row">'."\n";
                                        $editdata.='<div class="file-field input-field col s12 m6">'."\n";
                                        $editdata.='<span class="img-center big">'."\n";
                                        $editdata.='<img src="<?php echo base_url("uploads").'/'.$before->'.$sqlname.'; ?>" ></span>'."\n";

                                        $editdata.='<div class="btn blue darken-4">'."\n";
                                        $editdata.='<span>'.$title.'</span>'."\n";
                                        $editdata.='<input type="file" name="'.$sqlname.'" multiple>'."\n";
                                        $editdata.='</div>'."\n";
                                        $editdata.='<div class="file-path-wrapper">'."\n";
                                        $editdata.='<input class="file-path validate" type="text" placeholder="Upload one or more files" value=\'<?php echo set_value(\''.$sqlname.'\',$before->'.$sqlname.');?>\'>'."\n";
                                        $editdata.='<?php if($before->image == "") { } else { ?> <?php } ?>'."\n";
                                        $editdata.='</div>'."\n";
                                        $editdata.='</div>'."\n";
                                        $editdata.='</div>'."\n";
										}
...
//                                    $createdata.='<td>" + resultrow.'.$sqlname.' + "</td>';
                                    ...
                                    $editdata.='<div class="row">'."\n";
                                    $editdata.='<div class="col s6">'."\n";
                                    $editdata.='<button type="submit" class="btn btn-primary waves-effect waves-light  blue darken-4">Save</button>'."\n";
                                    $editdata.="<a href='<?php echo site_url(\"site/view".$tablename."\"); ?>' class='btn btn-secondary waves-effect waves-light red'>Cancel</a>"."\n";
                                    $editdata.='</div>'."\n";
                                    $editdata.='</div>'."\n";
